...
#include "rtthread.h"
#include "rtdevice.h"
#define VS_DQ       GET_PIN(B, 2)    //DREQ
#define VS_RST      GET_PIN(B, 1)    //RST
#define VS_XCS      GET_PIN(G, 10)   //XCS
#define VS_XDCS     GET_PIN(E, 4)    //XDCS
//////////////////////////////////////////////////////////////
...
extern _vs10xx_obj vsset;       //VS1053设置

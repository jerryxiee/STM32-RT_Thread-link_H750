...
//    rt_pin_mode(cfg->sda, PIN_MODE_OUTPUT_OD);
    ...
    GPIO_InitTypeDef GPIO_Initrue={0};
    GPIO_Initrue.Pin = GPIO_PIN_8;
    GPIO_Initrue.Mode = GPIO_MODE_OUTPUT_PP;
    GPIO_Initrue.Pull = GPIO_PULLUP;
    GPIO_Initrue.Speed = GPIO_SPEED_FREQ_HIGH;
    HAL_GPIO_Init(GPIOA, &GPIO_Initrue);

    GPIO_Initrue.Pin = GPIO_PIN_10;
    GPIO_Initrue.Mode = GPIO_MODE_OUTPUT_OD;
    GPIO_Initrue.Pull = GPIO_PULLUP;
    GPIO_Initrue.Speed = GPIO_SPEED_FREQ_HIGH;
    HAL_GPIO_Init(GPIOA, &GPIO_Initrue);

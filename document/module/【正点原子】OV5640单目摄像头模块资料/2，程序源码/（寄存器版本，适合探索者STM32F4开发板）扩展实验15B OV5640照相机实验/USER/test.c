...
u8 ov5640_jpg_photo(u8 *pname)
{
	...
	OV5640_OutSize_Set(16,4,1600,1200);		//设置输出尺寸(SXGA)  
...
{  
	...
	Show_Str(30,50,210,16,"Explorer STM32F4开发板",16,0);	 			    	 
	Show_Str(30,70,200,16,"基于OV5640的照相机实验",16,0);				    	 
	...
	{		    
		Show_Str(30,190,240,16,"PHOTO文件夹错误!!!!!",16,0);
		delay_ms(200);				  
	...
	jpeg_data_buf=mymalloc(SRAMEX,960*1024);		//为jpeg文件申请内存(最大960KB)
